...
data_dir = '/home/equant/work/data/test_data/sorghum_3d_travis/2020-07-29__20-33-38-393/'
east_pcd = o3d.io.read_point_cloud(data_dir + "f5778b8f-4e6e-4fc5-a3ea-003ed7e9b5e6__Top-heading-east_0.ply", print_progress=True)
west_pcd = o3d.io.read_point_cloud(data_dir + "f5778b8f-4e6e-4fc5-a3ea-003ed7e9b5e6__Top-heading-west_0.ply", print_progress=True)

print(east_pcd)
print(west_pcd)
print()

threshold = 10.0  #Movement range threshold for ICP
